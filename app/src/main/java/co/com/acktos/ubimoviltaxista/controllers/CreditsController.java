...
public class CreditsController {
    ...
    //Volley Request Tags
    private final static String TAG_GET_CREDITS="get_credits";
    private final static String TAG_PURCHASE_CREDIT="purchase_credit";

    public CreditsController(Context context){
    ...
    public void getCredits(
        ...
        StringRequest stringReq = new StringRequest(
                ...
                Request.Method.POST,
                Config.API.GET_LAST_CREDIT.getUrl(),
        ...
        AppController.getInstance().addToRequestQueue(stringReq, TAG_GET_CREDITS);
    ...
    public void purchaseCredit(final String carId,
        ...
        StringRequest stringReq = new StringRequest(
                ...
                Request.Method.POST,
                Config.API.PURCHASE_CREDIT.getUrl(),
                new Response.Listener<String>() {
